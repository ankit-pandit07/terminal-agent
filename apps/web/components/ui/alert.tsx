  ...
  "relative w-full rounded-xl border p-4 [&>svg~*]:pl-7 [&>svg+div]:translate-y-[-3px] [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4 [&>svg]:text-foreground",
  {
    variants: {
      variant: {
        ...
        destructive:
          "border-red-900/50 bg-red-950/30 text-red-300 [&>svg]:text-red-400",
        warning:
          "border-amber-900/50 bg-amber-950/30 text-amber-300 [&>svg]:text-amber-400",
        success:
          "border-emerald-900/50 bg-emerald-950/30 text-emerald-300 [&>svg]:text-emerald-400",
        info:
          "border-blue-900/50 bg-blue-950/30 text-blue-300 [&>svg]:text-blue-400",
      },
    },
    defaultVariants: {
      variant: "default",
